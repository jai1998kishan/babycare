...
AdminRouter.get("/newsletter/delete/:_id", isLogin, deleteNewsletter);
...
AdminRouter.get("/user/update-profile", isLogin, updateProfile);
AdminRouter.post("/user/update-profile", isLogin, encoder, updateProfileStore);
AdminRouter.get("/user/logout", isLogin, logout);
