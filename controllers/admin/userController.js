  ...
  if (req.body.password === req.body.cpassword) {
    if (schema.validate(req.body.password)) {
      ...
      res.render("admin/user/create", {
        ...
        errorMessage: {
          password:
            "Invalid Password. It Must Containe at least 1 upper case and 1 lower case, 1 digit, should not contain any space and length should be between 8 to 100",
        },
        data: data,
        session: req.session,
      });
...
// End of Admin Update Profile update
